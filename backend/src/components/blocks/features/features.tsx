  ...
  return (
    <section id="features" className="px-4 py-16">
      ...
      <div className="mx-auto max-w-6xl space-y-8 lg:space-y-20 dark:[--color-border:color-mix(in_oklab,var(--color-white)_10%,transparent)]">
        <HeaderSection
          title="Features"
          subtitle="Your SaaS Product Features"
          subtitleAs="h2"
          description="Please introduce your SaaS product features here"
          descriptionAs="p"
        />
          ...
          <div className="lg:col-span-5 flex flex-col gap-8">
            <div className="lg:pr-0 text-left">
              ...
              <p className="mt-4 text-muted-foreground">
                Please introduce your SaaS product features here
              </p>
            </div>
            <Accordion
              type="single"
            ...
            >
              <AccordionItem value="item-1">
                ...
                <AccordionContent className="text-muted-foreground">
                  Please describe your product feature one in detail here
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2">
                ...
                <AccordionContent className="text-muted-foreground">
                  Please describe your product feature two in detail here
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-3">
                ...
                <AccordionContent className="text-muted-foreground">
                  Please describe your product feature three in detail here
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-4">
                ...
                <AccordionContent className="text-muted-foreground">
                  Please describe your product feature four in detail here
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
