      ...
      <div className="border-t py-8">
        <Container className="px-4 flex items-center justify-between gap-x-4">
          ...
          <div className="flex items-center gap-x-4">
            <a
              href="https://backlinkdirs.com/item/buildway"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex shrink-0"
              aria-label="Listed on Backlink Dirs"
            >
              <img
            ...
            <a
              href="https://aidirs.org/item/buildway"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex shrink-0"
              aria-label="Listed on AIDirs"
            >
              <img
                src="https://aidirs.org/badges/badge-listed-light.svg"
            ...
            <a
              ...
              rel="noopener noreferrer"
              className="inline-flex shrink-0"
              aria-label="Featured on BestskyTools"
            >
              <img
            ...
            <a
              ...
              rel="noopener noreferrer"
              className="inline-flex shrink-0"
              aria-label="Featured on DeepLaunch.io"
            >
              <img
